...
<link href="JoinForm.css" rel="stylesheet" type="text/css" />
...
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="list.do" style="padding: 10px 20px;">게시판</a>
</li>
</ul>
          </div>
...
<a href="index.html"><h1 class="u-text u-text-default u-text-1">Live Score</h1></a>
      ...
      <form action="joinAction.jsp" method="POST" class="joinForm" onsubmit="DoJoinForm__submit(this); return false;">                                                                                       
	      <h2>회원가입</h2>
	      <div class="textForm">
	      ...
	      <div class="textForm">
	        <input name="userEmail" type="email" class="cellphoneNo" placeholder="이메일">
	      </div>
